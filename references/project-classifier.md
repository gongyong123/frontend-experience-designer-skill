...
- Official website plus admin/user management/control panel: treat as `marketing-site + admin-system`; use `architecture-defaults.md` and stop to confirm whether to split into separate apps before scaffolding a new project.
